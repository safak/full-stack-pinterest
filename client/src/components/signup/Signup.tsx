...
import type { ChangeModalCallback, SignupCallback } from "@/routes/auth/AuthPage"
...
const Signup = ({ onSignup, changeModal }: { onSignup: SignupCallback, changeModal: ChangeModalCallback }) => {
